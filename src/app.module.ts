...
import { ValidatedNumberModule } from './modules/validated-number/validated-number.module';
      ...
      useFactory: (configService: ConfigService) => {
        ...
        const baseConfig = {
          entities: [
            ...
            __dirname + '/modules/validated-number/**/*.entity{.ts,.js}',
          ],
